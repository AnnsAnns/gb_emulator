...
impl CPU {
    ...
    pub fn increment_timer(&mut self) {
        ...
        if self.mmu.read_byte(0xFF07) & 0b100 == 0 {
            return;
        }

        let previous_val = self.mmu.read_byte(TIMER_COUNTER_ADDRESS);
